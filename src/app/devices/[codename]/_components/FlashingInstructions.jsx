...
const FlashingInstructions = (props) => {
  ...
  const renderInstructions = () => {
    ...
    const downloadBaseURL = `https://cdn.evolution-x.org/${codename}/${androidVersion}/${filename}/download`
    ...
    const filesToDownload = [
      ...initialInstallationImages.map((img) => ({
        name: `${img}.img`,
        url: `https://cdn.evolution-x.org/${codename}/${androidVersion}/${img}/${img}.img/download`
      })),
