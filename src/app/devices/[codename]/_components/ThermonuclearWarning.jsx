    ...
    >
      ...
      >
        <div className='flex flex-col gap-4'>
          <p className='font-productsans text-xl font-bold text-[#ff5e00] lg:text-3xl'>
            Before you download and install!
          </p>
          <p className='font-productsans text-base font-light lg:text-xl'>
            ...
            <a
              ...
              className='evoxhighlight font-productsans font-bold'
            >
              laugh
            </a>{' '}
            at you.
