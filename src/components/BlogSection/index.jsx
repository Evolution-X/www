...
export default function index() {
  return (
    <div className="mx-4 md:mx-20 md:-mb-20 md:-mt-24">
      <div className="flex flex-col gap-10 rounded-3xl border border-[#2a2828] bg-[#070505] p-8 md:p-16">
        ...
        <div className="mt-6 text-3xl text-white md:text-5xl">
