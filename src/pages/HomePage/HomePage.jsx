...
import { BackgroundGradientAnimation } from './components/background-gradient-animation.tsx'
...
const HomePage = () => {
  const { latestAndroidVersion, loading, error } = useVersion()
      ...
      >
        ...
        <div className='inline-flex flex-col items-center gap-2 pt-3 text-center sm:flex-row sm:gap-3 lg:flex-row lg:gap-6'>
          <Link to='/devices'>
            ...
            >
              <div className=''>Browse Devices</div>
            </motion.div>
          </Link>
