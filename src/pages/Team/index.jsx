...
const Team = () => {
  ...
  return (
    <>
      <Helmet>
        <meta property="og:title" content="Evolution X - Team" />
        <meta
          property="og:description"
          content="Meet the amazing team behind Evolution X!"
        />
        <meta property="og:url" content="https://evolution-x.org/team" />
        <meta
          property="og:image"
